...
Form memiliki menu Detail, Foto, Link, dan Preview. Foto bisa diunggah (JPG/PNG/WebP, maksimal 5 MB), drag-and-drop, atau memakai URL publik. File foto tersimpan di `uploads/`; sertakan folder ini bersama `projects.json` saat commit dan push. Kategori di halaman portfolio memakai dropdown dengan jumlah project per kategori.
